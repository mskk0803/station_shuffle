...
ActiveRecord::Schema[7.2].define(version: 2025_04_20_153332) do
  ...
  create_table "notifications", force: :cascade do |t|
    t.uuid "user_id", null: false
    t.string "notifable_type", null: false
    t.bigint "notifable_id", null: false
    t.boolean "read", default: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["notifable_type", "notifable_id"], name: "index_notifications_on_notifable"
